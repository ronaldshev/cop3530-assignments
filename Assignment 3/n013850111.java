 ...
 * Solution as a recursive algorithm.
 *
 * Description:
 * This program implements knapsack problem using recursion. It DOES NOT STORE the already calculated values.
 * To calculate the execution time, I have used profiling tool in the IDE. It starts and stops the stop watch
 * at defined points. I have defined the start point at 123 and end point at 186
